...
// ---------------------------------------------------------------------------
// POST /{uuid}/cancel  aur  /{uuid}/resume  — dono ka shape same
// ---------------------------------------------------------------------------

class MembershipActionResult extends Equatable {
  final String uuid;
  final String status; // TERMINATED | ACTIVE
  final DateTime? accessUntil; // cancel
  final DateTime? endAt; // resume
  final String message; // backend ka apna text
  ...
  DateTime? get effectiveUntil => endAt ?? accessUntil;

  factory MembershipActionResult.fromJson(
      Map<String, dynamic> json, {
        String message = '',
  ...
  @override
  List<Object?> get props => [uuid, status, accessUntil, endAt, message];
}