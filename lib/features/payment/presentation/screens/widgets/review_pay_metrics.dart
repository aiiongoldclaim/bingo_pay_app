...
class ReviewPayMetrics {
  ...
  factory ReviewPayMetrics.phone() => ReviewPayMetrics(
    ...
    itemMetaSize: 12.sp,
    rowLabelSize: 15.sp,
    rowValueSize: 14.5.sp,
    totalLabelSize: 15.sp,
    totalValueSize: 17.sp,
    stripIconBox: 12.w,
    stripIconSize: 21.sp,
    stripTitleSize: 14.5.sp,
    stripSubSize: 13.5.sp,
    offerIconBox: 10.w,
    offerIconSize: 17.sp,
    offerTitleSize: 14.5.sp,
    offerSubSize: 13.5.sp,
    linkSize: 14.sp,
    fieldHeight: 6.2.h,
    fieldRadius: 10,
    fieldTextSize: 14.sp,
