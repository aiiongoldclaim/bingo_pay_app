...
//         if (heroAuction != null) const SizedBox(height: 28),
...
//   const _HeroAuctionCard({required this.auction, required this.onTap});
...
//               children: [
//                 Expanded(
//                   child: _HeroInformation(auction: auction, onTap: onTap),
//                 ),
...
//               _HeroInformation(auction: auction, onTap: onTap),
//             ],
//           );
//         },
//       ),
...
//   const _HeroInformation({required this.auction, required this.onTap});
...
// class _ViewMyBidsButton extends StatelessWidget {
//   final VoidCallback onPressed;

//   const _ViewMyBidsButton({required this.onPressed});
...
//           side: const BorderSide(color: Color(0xFFE4B94F), width: 1.2),
...
//   const _AuctionProductCard({required this.auction, required this.onTap});
