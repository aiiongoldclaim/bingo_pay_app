...
class BookingDetailsMetrics {
  ...
  factory BookingDetailsMetrics.phone() => const BookingDetailsMetrics(
    ...
    heroMetaIconSize: 22,
    heroMetaIconGapW: 8,
    heroMetaLabelSize: 13.5,
    heroMetaLabelGapH: 2,
    heroMetaValueSize: 13,

    sectionIconSize: 18,
    sectionIconGapW: 7,
    sectionTitleTextSize: 15,
    ...
    paymentBannerTextSize: 13,

    timelineTitleSize: 14.5,
    ...
    timelineItemTitleSize: 13.5,
    timelineItemGapH: 3,
    timelineItemSubtitleSize: 13,
    ...
    detailIconSize: 15,
    detailGapW: 10,
    detailLabelSize: 12.5,
    detailValueSize: 12.5,
