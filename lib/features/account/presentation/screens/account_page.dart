                  ...
                  child: Column(
                    children: [
                      AccountHeader(
                        account: account,
                        onEdit:
                        context.read<AccountCubit>().onEditProfile,
                        onWalletTap: () {
                          context.push(
                            AppRoutes.wallet,
                          );
                      ...
                      BlocBuilder<MembershipCubit, MembershipState>(
                        builder: (
                          ...
                          final hasMembership =
                              membershipState.membership.subscription !=
                                  null;
...
class AccountShimmerContent extends StatelessWidget {
  const AccountShimmerContent({
    super.key,
  });
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _SecondaryTile(
            icon: AccountMenuItem.iconFor('logout'),
            title: 'Logout',
    ...
    return Material(
      ...
      child: InkWell(
        ...
        borderRadius: BorderRadius.vertical(
          top: Radius.circular(
            isFirst ? m.menuRadius : 0,
          ),
          bottom: Radius.circular(
            isLast ? m.menuRadius : 0,
          ),
        ),
        child: Padding(
          padding: EdgeInsets.symmetric(
