...
class ProfileMetrics {
  ...
  static ProfileMetrics of(BuildContext context) {
    final shortest = MediaQuery.sizeOf(context).shortestSide;
    final size = MediaQuery.sizeOf(context);
    final isTablet = shortest >= 540;
    final isLandscape = size.width > size.height;

    if (!isTablet) return ProfileMetrics.phone();
    return isLandscape
        ? ProfileMetrics.tabletLandscape(size)
        : ProfileMetrics.tabletPortrait(size);
  }

  // ── PHONE ────────────────────────────────────────────────────────────────
  factory ProfileMetrics.phone() => ProfileMetrics(
    pageHPad: 4.w,
  ...
  // ── TABLET PORTRAIT ──────────────────────────────────────────────────────
  factory ProfileMetrics.tabletPortrait(Size size) {
    final w = size.width;
  ...
  // ── TABLET LANDSCAPE ─────────────────────────────────────────────────────
  factory ProfileMetrics.tabletLandscape(Size size) {
    final w = size.width;
    return ProfileMetrics(
