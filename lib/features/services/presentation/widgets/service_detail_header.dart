...
class ServiceDetailHeader extends StatefulWidget {
  ...
  const ServiceDetailHeader({super.key, required this.service});
...
class _ServiceDetailHeaderState extends State<ServiceDetailHeader> {
  ...
  void _updateCardPosition() async {
    ...
    try {
      ...
      setState(() {
        _cardLeft = (screenCoord.x - 52)
            .toDouble(); // Center the card (52 is half width)
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        // Address
        if (widget.service.locationLabel != null &&
            widget.service.locationLabel!.isNotEmpty)
          Row(
            children: [
              Icon(
        ...
        Row(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.star_rounded, size: 17.sp, color: colors.brand),
                SizedBox(width: 0.5.w),
                Text(
