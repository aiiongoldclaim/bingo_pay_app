...
import 'package:bingo_pay/features/auth/domain/usecases/check_auth_status_usecase.dart'
    as _i308;
import 'package:bingo_pay/features/auth/domain/usecases/check_user_exists_usecase.dart'
    as _i947;
...
import 'package:bingo_pay/features/auth/presentation/bloc/auth_bloc.dart'
    as _i357;
import 'package:bingo_pay/features/auth/presentation/cubit/email_exists_cubit.dart'
    as _i4;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  Future<_i174.GetIt> init({
    ...
    gh.factory<_i947.CheckUserExistsUseCase>(
      () => _i947.CheckUserExistsUseCase(gh<_i917.AuthRepository>()),
    );
    ...
    gh.factory<_i4.EmailExistsCubit>(
      () => _i4.EmailExistsCubit(gh<_i947.CheckUserExistsUseCase>()),
    );
